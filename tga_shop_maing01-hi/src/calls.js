...
let Calls = {
  ...
  productList() {
    let commandUri = "http://localhost:8080/tga-shop-maing01/22222222222222222222222222222222/product/list";
    return Calls.call("get", commandUri, {});
  },

  orderGet() {
    let commandUri = "http://localhost:8080/tga-shop-maing01/22222222222222222222222222222222/order/get";
    return Calls.call("get", commandUri, { id: "611d1105bd7d432e048d0560" });
  },

  orderAddProduct(product) {
    let commandUri = "http://localhost:8080/tga-shop-maing01/22222222222222222222222222222222/order/addProduct";
    console.log(`product id: ${product.id} added to basket (calls)`);
    return Calls.call("post", commandUri, {});
  },

  getForUserByState() {
    let commandUri = Calls.getCommandUri("order/getForUserByState");
    return Calls.call("get", commandUri, { state: "cart" });
  },

  loadProduct(dtoIn) {
    let commandUri = Calls.getCommandUri("product/load");
    return Calls.call("get", commandUri, dtoIn);
  },

  buy(orderId) {
    console.log(`order/buy was called from calls.js with order Id: ${orderId}`);
    let commandUri = "http://localhost:8080/tga-shop-maing01/22222222222222222222222222222222/order/buy";
    return Calls.call("post", commandUri, { id: orderId });
  },
