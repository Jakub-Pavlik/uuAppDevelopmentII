      ...
      >
        <Plus4U5.App.MenuTree
          ...
          items={[
            ...
            { id: "products", href: "products", content: <UU5.Bricks.Lsi lsi={Lsi.left.products} /> },
            { id: "cart", href: "cart", content: <UU5.Bricks.Lsi lsi={Lsi.left.cart} /> },
            { id: "listForAdmin", href: "listForAdmin", content: <UU5.Bricks.Lsi lsi={Lsi.left.listForAdmin} /> },
            { id: "listForUser", href: "listForUser", content: <UU5.Bricks.Lsi lsi={Lsi.left.listForUser} /> },
          ]}
        />
      </Plus4U5.App.Left>
    );
