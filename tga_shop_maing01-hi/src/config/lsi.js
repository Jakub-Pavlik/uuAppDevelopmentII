const Lsi = {
  ...
  about: {
    header: {
      cs: "O aplikaci tgaShop",
      en: "About application tgaShop",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní tgaShop.",
      en: "You can buy your own tgaShop.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci tgaShop.",
      en: "You don't have rights to initialize this tgaShop.",
    },
  },
